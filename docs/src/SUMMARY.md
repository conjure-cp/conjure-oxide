...
- [Architecture]()
  ...
  - [Adaptors]()
    - [Overview](docs/src/developers-guide/architecture/adaptors/overview.md)
    - [Rule Types](docs/src/developers-guide/architecture/adaptors/overview.md)
    - [SAT]()
      - [SAT Adaptor Overview](developers-guide/architecture/sat-encoding/implementation-details-overview.md)
