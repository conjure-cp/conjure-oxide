...
- [Architecture]()
  ...
  - [SAT](developers-guide/architecture/sat-encoding/overview.md)
    - [Overview](developers-guide/architecture/sat-encoding/overview.md)
    - [SAT Adaptor](developers-guide/architecture/sat-encoding/sat-adaptor.md)
    ...
    - [Creating Transformation Rules](developers-guide/architecture/sat-encoding/creating-transformation-rules.md)
      ...
      - [Tricks for SAT](developers-guide/architecture/sat-encoding/tricks.md)
    - [Concrete SAT Rules]()
      - [Direct Encoding SAT Summation](developers-guide/architecture/sat-encoding/concrete_sat_rules/direct-encoding-summation.md)
      - [Order Encoding Inequality](developers-guide/architecture/sat-encoding/concrete_sat_rules/order-encoding-inequality.md)
      - [Order Encoding Division](developers-guide/architecture/sat-encoding/concrete_sat_rules/order-encoding-division.md)
      - [Order Encoding Negation](developers-guide/architecture/sat-encoding/concrete_sat_rules/order-encoding-negation.md)
      - [Direct Encoding Absolute Value](developers-guide/architecture/sat-encoding/concrete_sat_rules/direct-encoding-abs.md)
      - [Direct Encoding Division](developers-guide/architecture/sat-encoding/concrete_sat_rules/direct-encoding-division.md)
  - [Sets]()
