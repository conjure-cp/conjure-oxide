...
- [Architecture]()
  ...
  - [SAT]()
    ...
    - [Order Encoding Division](developers-guide/architecture/sat-encoding/order-encoding-division.md)
    - [Direct Encoding Absolute Value](developers-guide/architecture/sat-encoding/direct-encoding-abs.md)
    - [Direct Encoding Division](developers-guide/architecture/sat-encoding/direct-encoding-division.md)
  - [Sets]()
