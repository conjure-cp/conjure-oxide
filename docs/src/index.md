...
This site contains the user documentation for Conjure Oxide; other useful links can be found on the [useful links](welcome/useful-links.md) page.
...
[contributor's guide](contributors-guide/index.md).
