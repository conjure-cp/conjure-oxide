__CST__ - Concrete Syntax Tree. Generated by the tree-sitter when parsing an essence file. 
...
At the moment says no solutions found. Would want to explicitly dissalow it. 
