...
This page stays intentionally short. The reusable technique is described in [SAT Rule Implementation Patterns](./sat-generic-patterns.md), and the current source of truth is `crates/conjure-cp-rules/src/sat/direct_int_ops.rs` (`add_sat_direct`).
