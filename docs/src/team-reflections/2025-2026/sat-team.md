...
In the second semester, we stopped using formal Agile roles. Instead, people picked their own tasks and worked on them. We replaced regular meetings with updates in Teams to keep everyone informed. We kept using the +1/+2 system to keep the code consistent.
