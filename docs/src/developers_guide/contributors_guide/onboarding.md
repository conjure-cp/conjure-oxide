...
Also, the VIP is a fundamentally cooperative project, and so do not be afraid to ask for help from a more experienced member of the team if you are struggling to understand an important part of the code.
...
One option is to delay your actual project selection by first tackling a smaller starter project. There are always little issues in the codebase needing addressed and working on one of these, while you learn, can be a fantastic way to get a confidence boost from feeling productive. However, be aware that taking on a wide project with a lot of reach, even if small, can be very challenging for a new start, as it requires deeply understanding many different areas of the code.
...
Also ensure to ask for help and talk to the rest of the team. There will be people on the project who have done it for years now. Use their expertise.