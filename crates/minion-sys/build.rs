...
fn bind() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("getVarByName_safe")
        .allowlist_function("newVar_ffi")
        .allowlist_function("newVar_ffi_safe")
        .allowlist_function("minion_get_last_error")
        .allowlist_function("minion_clear_last_error")
