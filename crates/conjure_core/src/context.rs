...
pub struct Context<'a> {
    pub target_solver: Arc<RwLock<SolverName>>,
...
impl<'a> Context<'a> {
    pub fn new(target_solver: SolverName, target_solver_family: SolverFamily, extra_rule_set_names: Vec<String>) -> Self {
        Context {
            target_solver: Arc::new(RwLock::new(target_solver)),
...
impl<'a> Default for Context<'a> {
    fn default() -> Self {
        Context {
            target_solver: Arc::new(RwLock::new(SolverName::default())),
