...
#[register_rule(("Base", 9000), applicable_to(Expr::LexGt(..) | Expr::LexGeq(..)))]
...
#[register_rule(("Minion", 2000), applicable_to(Expr::LexLt(..) | Expr::LexLeq(..)))]
...
#[register_rule(("Smt", 2001), applicable_to(Expr::LexLt(..) | Expr::LexLeq(..)))]
