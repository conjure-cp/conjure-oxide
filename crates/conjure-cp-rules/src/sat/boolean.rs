...
///  clause(a)
/// ```
#[register_rule(("SAT", 8400), applicable_to(Expr::Root(..)))]
...
///  ...
/// ```
#[register_rule(("SAT", 8500), applicable_to(Expr::And(..) | Expr::Or(..)))]
...
/// ```
#[register_rule(("SAT", 9005), applicable_to(Expr::Not(..)))]
...
/// ```
#[register_rule(("SAT", 8500), applicable_to(Expr::Iff(..) | Expr::Eq(..)))]
...
///  clause(__0, not(b))
/// ```
#[register_rule(("SAT", 8500), applicable_to(Expr::Imply(..)))]
...
///  clause(not(a), b, __0)
/// ```
#[register_rule(("SAT", 8500), applicable_to(Expr::Neq(..)))]
