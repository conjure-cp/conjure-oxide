...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Lt(..) | Expr::Gt(..) | Expr::Leq(..) | Expr::Geq(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 9100), applicable_to(Expr::Eq(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Neq(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Sum(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 9000), applicable_to(Expr::Product(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Neg(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Min(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Max(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::Abs(..)))]
...
///
/// ```
#[register_rule(("SAT_Log", 4100), applicable_to(Expr::SafeDiv(..)))]
