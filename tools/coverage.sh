...
grcov . -s . --binary-path ./target/debug -t html --ignore-not-existing --ignore 'target/**/*.rs' --ignore '**/main.rs' --ignore '**/build.rs' -o ./target/debug/coverage
grcov . -s . --binary-path ./target/debug -t lcov --ignore-not-existing --ignore 'target/**/*.rs' --ignore '**/main.rs' --ignore '**/build.rs' -o ./target/debug/lcov.info
