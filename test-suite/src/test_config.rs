...
fn deserialise_skip<'de, D>(deserializer: D) -> Result<String, D::Error>
where
    D: serde::Deserializer<'de>,
{
    #[derive(Deserialize)]
...
pub struct TestConfig {
    ...
    #[serde(default = "default_skip", deserialize_with = "deserialise_skip")]
    pub skip: String,
